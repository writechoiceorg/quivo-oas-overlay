...
<Tabs>
  <Tab title="Request">
    ...
    <Note>
      Replace `${BASE_URL}` with the correct base URL: `https://api.quivo.co` for Production or `https://api-sandbox.quivo.co` for Sandbox. Replace the placeholders with your actual warehouse ID and seller ID.
    </Note>
  </Tab>
  <Tab title="Response">
...
<Tabs>
  <Tab title="Request">
    ...
    <Note>
      Replace `${BASE_URL}` with the correct base URL: `https://api.quivo.co` for Production or `https://api-sandbox.quivo.co` for Sandbox. Use the `itemId` from the item list response.
    </Note>
  </Tab>
  <Tab title="Response">
...
<Tabs>
  <Tab title="Request">
    ...
    <Note>
      Replace `${BASE_URL}` with the correct base URL: `https://api.quivo.co` for Production or `https://api-sandbox.quivo.co` for Sandbox. Use the `itemId` from the item details.
    </Note>
  </Tab>
  <Tab title="Response">
...
<Tabs>
  <Tab title="Request">
    ...
    <Note>
      Replace `${BASE_URL}` with the correct base URL: `https://api.quivo.co` for Production or `https://api-sandbox.quivo.co` for Sandbox. You can use query parameters like `query` and `sort` to filter and sort the results.
    </Note>
  </Tab>
  <Tab title="Response">
...
<Tabs>
  <Tab title="Request">
    ...
    <Note>
      Replace `${BASE_URL}` with the correct base URL: `https://api.quivo.co` for Production or `https://api-sandbox.quivo.co` for Sandbox. This operation syncs the item's inventory data with the warehouse system.
    </Note>
  </Tab>
  <Tab title="Response">
...
<Tabs>
  <Tab title="Request">
    ...
    <Note>
      Replace `${BASE_URL}` with the correct base URL: `https://api.quivo.co` for Production or `https://api-sandbox.quivo.co` for Sandbox. This operation syncs all items for your seller account with the warehouse system.
    </Note>
  </Tab>
  <Tab title="Response">
