...
<Tabs>
  <Tab title="Request">
    Use this request to generate an upload URL for a product image.
    ...
    <Note>
      Replace `${BASE_URL}` with the correct base URL configured for your account. Use the `articleId` returned when you created the article.
    </Note>
  </Tab>
  <Tab title="Response">
...
<Tabs>
  <Tab title="Request">
    ...
    <Note>
      Replace `${BASE_URL}` with the correct base URL configured for your account. Use the `query` parameter to filter results, `sort` to order them, and `pageSize` to limit the number of results.
    </Note>
  </Tab>
  <Tab title="Response">
...
<Tabs>
  <Tab title="Request">
    ...
    <Note>
      Replace `${BASE_URL}` with the correct base URL configured for your account. Include all fields you want to keep, not just the ones you're updating. The request body should contain the complete article data.
    </Note>
  </Tab>
  <Tab title="Response">
...
<Tabs>
  <Tab title="Request">
    ...
    <Note>
      Replace `${BASE_URL}` with the correct base URL configured for your account. Specify the `mimeType` query parameter, for example `image/jpeg` or `image/png`.
    </Note>
  </Tab>
  <Tab title="Response">
...
<Tabs>
  <Tab title="Request">
    ...
    <Note>
      Replace `${BASE_URL}` with the correct base URL configured for your account. Use the image `id` from the article details.
    </Note>
  </Tab>
  <Tab title="Response">
...
<Tabs>
  <Tab title="Request">
    ...
    <Note>
      Replace `${BASE_URL}` with the correct base URL configured for your account. Include the article data you want to validate in the request body.
    </Note>
  </Tab>
  <Tab title="Response">
